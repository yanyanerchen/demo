 ...
 * @param {number=} options.relation.oneTwoRelation 第一列和第二列是否通过p关联
 * @param {number=} options.relation.twoThreeRelation 第二列和第三列是否通过p关联
 * @param {number=} options.relation.threeFourRelation 第三列和第四列是否通过p关联
 * @param {number=} options.relation.fourFiveRelation 第四列和第五列是否通过p关联
	...
	IosSelect.prototype = {
		...
		initLayer: function() {
			...
			this.scrollOne.on('scrollEnd', function() {
				...
				if (self.level > 1 && self.options.oneTwoRelation === 1) {
					self.setTwoLevel(self.selectOneObj.i, self.selectTwoObj.i, self.selectThreeObj.i, self.selectFourObj.i, self.selectFiveObj.i);
				}
			});
			...
			if (this.level >= 2) {
				...
				this.scrollTwo.on('scrollEnd', function() {
					...
					if (self.level > 2 && self.options.twoThreeRelation === 1) {
						self.setThreeLevel(self.selectOneObj.i, self.selectTwoObj.i, self.selectThreeObj.i, self.selectFourObj.i, self.selectFiveObj.i);
					}
				});
			...
			if (this.level >= 3) {
				...
				this.scrollThree.on('scrollEnd', function() {
					...
					if (self.level >= 4 && self.options.threeFourRelation === 1) {
						self.setFourLevel(self.selectOneObj.i, self.selectTwoObj.i, self.selectThreeObj.i, self.selectFourObj.i, self.selectFiveObj.i);
					}
				});
			...
			if (this.level >= 4) {
				...
				this.scrollFour.on('scrollEnd', function() {
					...
					if (self.level >= 5 && self.options.fourFiveRelation === 1) {
						self.setFiveLevel(self.selectOneObj.i, self.selectTwoObj.i, self.selectThreeObj.i, self.selectFourObj.i, self.selectFiveObj.i);
					}
				});
		...
		renderOneLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, oneLevelData) {
			...
			oneLevelData.forEach(function(v, i, o) {
				if (v.i == oneLevelId) {
					oneHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';" ' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.n + '</li>';
					plast = i + 1;
				} else {
					oneHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + '>' + v.n + '</li>';
				}
			}.bind(this));
			oneHtml += this.getWhiteItem();
		...
		renderTwoLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, twoLevelData) {
			...
			twoLevelData.forEach(function(v, i, o) {
				if (v.i == twoLevelId) {
					twoHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.n + '</li>';
					plast = i + 1;
				} else {
					twoHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + '>' + v.n + '</li>';
				}
			}.bind(this));
			twoHtml += this.getWhiteItem();
	    ...
	    renderThreeLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, threeLevelData) {
			...
			threeLevelData.forEach(function(v, i, o) {
				if (v.i == threeLevelId) {
					threeHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.n + '</li>';
					plast = i + 1;
				} else {
					threeHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + '>' + v.n + '</li>';
				}
			}.bind(this));
			threeHtml += this.getWhiteItem();
	    ...
	    renderFourLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, fourLevelData) {
			...
			var hasAtId = fourLevelData.some(function(v, i, o) {
				return v.i == fourLevelId;
			});
			if (!hasAtId) {
				fourLevelId = fourLevelData[0]['i'];
			}
			var fourHtml = '';
			var self = this;
			...
			fourLevelData.forEach(function(v, i, o) {
				if (v.i == fourLevelId) {
					fourHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.n + '</li>';
					plast = i + 1;
				} else {
					fourHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + '>' + v.n + '</li>';
				}
			}.bind(this));
			fourHtml += this.getWhiteItem();
	    ...
	    renderFiveLevel: function(oneLevelId, twoLevelId, threeLevelId, fourLevelId, fiveLevelId, fiveLevelData) {
			...
			var hasAtId = fiveLevelData.some(function(v, i, o) {
				return v.i == fiveLevelId;
			});
			if (!hasAtId) {
				fiveLevelId = fiveLevelData[0]['i'];
			}
			var fiveHtml = '';
			var self = this;
			...
			fiveLevelData.forEach(function(v, i, o) {
				if (v.i == fiveLevelId) {
					fiveHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + ' class="at">' + v.n + '</li>';
					plast = i + 1;
				} else {
					fiveHtml += '<li style="height: ' + this.options.itemHeight + this.options.cssUnit + '; line-height: ' + this.options.itemHeight + this.options.cssUnit +';"' + iosSelectUtil.attrToHtml(v) + '>' + v.n + '</li>';
				}
			}.bind(this));
			fiveHtml += this.getWhiteItem();
